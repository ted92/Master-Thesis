...
time and it might be expensive in matter of
...
Each miner choose whether include a transaction into a block or not,
...
Proof-of-work is defined as follows\,\cite{proof-of-work}:
...
more than $120$\,million of transactions from $2013$ to $2017$.
\begin{table}
	\centering
...
\subsection{Users' Benefits} %TODO: CHECK THIS PARAGRAPH - graphs and mea for both functions, valutate whether make a separate subsubsection about the functions.
...
%has an average speed of $\sim1$\,MB/s and it does not go faster than $9$\,MB/s. This
...
\begin{table}
	...
	\multicolumn{1}{c|}{\textbf{Lower $\downarrow$}} \\ \hline
		...
		\end{itemize}&\begin{itemize}
			...
			\item [$-$] more latency $t_l$ %TODO: these last two are crytical
		\end{itemize}\\ \midrule
		\hline
...
%TODO: CALCULATE BETTER ACCURACY, MAYBE ON THE NEW NODES
...
%TODO: MINERS AND MINING POOLS, UNCONFIRMED TRANSACTION SCALABILITY

%TODO: THROUGHPUT AND LATENCY

%TODO: MINER PROFIT AND USERS BENEFITS

%TODO: RESULTS ABOUT SCALABILITY FEES TOLLS AND PERFORMANCE (Maybe a table with all the pros and cons)
%TODO: Talk about MAE and MSE, how much our regressions could be used in a real scenario etc.
%TODO: Is good also for green econonomy not to increase fees too much to avoid more miners to join having a lot of useless consumption
...
%
%\begin{multline}
%\label{eq:minerprofit39}
%f_{\langle \Pi \rangle}^{39} =
%4.969e-73 x^{39}  - 7.795e-71 x^{38}
%- 3.386e-69 x^{37}  + 3.058e-67 x^{36}\\
%+ 5.446e-65 x^{35}  + 3.425e-63 x^{34}
%- 5.872e-62 x^{33}  - 3.755e-59 x^{32}\\
%- 4.344e-57 x^{31}  - 2.314e-55 x^{30} 
%+ 9.424e-54 x^{29}  + 3.462e-51 x^{28}\\
%+ 3.784e-49 x^{27}  + 1.752e-47 x^{26} 
%- 1.356e-45 x^{25}  - 3.508e-43 x^{24}\\
%- 3.167e-41 x^{23}  - 4.471e-40 x^{22} 
%+ 2.666e-37 x^{21}  + 3.537e-35 x^{20} \\
%+ 1.104e-33 x^{19}  - 2.572e-31 x^{18} 
%- 3.51e-29 x^{17}  - 3.769e-29 x^{16} \\
%+ 3.772e-25 x^{15}  + 1.769e-23 x^{14}
%- 3.842e-21 x^{13}  - 1.709e-19 x^{12} \\
%+ 5.573e-17 x^{11}  - 4.363e-15 x^{10}
%+ 1.819e-13 x^9 - 4.429e-12 x^8\\
%+ 5.752e-11 x^7 - 1.553e-10 x^6
%- 6.055e-09 x^5 + 7.513e-08 x^4\\
%- 1.359e-07 x^3- 2.709e-06 x^2
%+ 1.648e-05 x + 1.924e-05
%\end{multline}
