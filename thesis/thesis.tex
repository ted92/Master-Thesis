...
%TODO: data are stored in different files with an overall size of $\sim$$25$\,GB.
...
%TODO: Our data frame allows us to collect all the useful information without storing the whole raw blockchain like current systems for blockchain analysis do, see \emph{BitcoinCore}\,\cite{bitcoincore}. Raw data are collected in \gls{json}, analyzed, printed in our data frame and then deleted. This gave us a $10x$ space saving on the blockchain, storing in a $1$\,GB data frame what the raw files from \emph{bitcoin.info} store in $10$\,GB space. Plus, we believe that analyzing a small percentage of the blockchain everyday would give us relevant information about the whole system, and due to time limitations we could collect only #% of the data, every day.

\subsection{Data Visualization}
\label{sec:datavisualization}
%TODO: ============= VISUALIZING DATA ============
%TODO: Pandas offer even a pretty plotting for our data
%TODO: Visualizing big data might be time consuming
