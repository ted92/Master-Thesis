...
and analyzed. We state that %TODO: FINISH STATEMENT ACCORDING TO RESULTS
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[width=1\linewidth]{img/market_share_blocks_1}
%	\caption{Mining power distribution in a scenario from $2013$ until $2015$, considering only the $5$ major mining pools.}
%	\label{fig:market_share_blocks_1}
%\end{figure}
%\begin{figure}[h]
%	\centering
%	\includegraphics[width=1\linewidth]{img/market_share_blocks_2}
%	\caption{Mining power distribution in a scenario from $2016$ until $2017$, considering only the $5$ major mining pools.}
%	\label{fig:market_share_blocks_2}
%\end{figure} 

%TODO: Tendy miners graph with at least 15 mining pools
%TODO: top_miners_monthly graph, number_of_miners graph
