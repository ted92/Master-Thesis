...
transaction latency and block creation time. %TODO: Continue after the creation_time_miners plot has been generated, to see if occasional miners tend to mine quicker when they mange to do so
...
%TODO: Throughput vary according to $Q$ and $\mathcal{T}$.
\begin{figure}[h]
	\centering
