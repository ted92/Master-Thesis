...
all the useful informations to process transactions and to
verify them. These informations consist in a huge quantity
...
These informations were collected from Bowles' book\,\cite{bowles2015machine}.
...
\subsubsection{Training a Dataset}
...
showing informations out of them might be tricky. For example, if
you have millions or billions of samples it will result
almost impossible to get any information by simply plotting them.
When analyzing longitudinal data for example, informations
...
%TODO: Talk about outliers, better to use median rather than mean when there are too many outliers in data collected.

\chapter{Blockchain Analytics System}
\label{chap:expsetup}
%TODO: We did longitudinal data - 50% of the blockchain for 3 years
