...
We assume then, having informations from the
...
each property, every row is telling what happen to the other attributes
...
%TODO: Explain the table, white spaces is where we don't have any guess. 
\begin{table}
	...
	\begin{tabular}{|p{1.5cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}|} \hline
		...
		\hline
		\textbf{$Q\uparrow$}& & &$\downarrow\downarrow$ &$\uparrow$ &$\downarrow$ &$\uparrow$ &$\uparrow\uparrow$\\
		\hline
		 \textbf{$\mathcal{T}\uparrow$}&$(\uparrow)$&&&$\downarrow$&&&\\
		\hline
		\textbf{$\tau\uparrow$}&$\downarrow\downarrow$&&&$\uparrow$&$(\downarrow)$&$(\uparrow)$&$\downarrow$ \\
		\hline
		\textbf{$\gamma\uparrow$}&$\uparrow$&$\downarrow$&&&$(\downarrow)$&$\uparrow$&$(\uparrow)$ \\
		\hline
		\textbf{$t_f\downarrow$}&&&$(\uparrow)$&&&$\uparrow$&\\
		\hline
		\textbf{$\langle C\rangle\downarrow$}&$\downarrow$&&&&$\uparrow$&&\\
		\hline
	\textbf{$\mathbb{P}_{orphan}\downarrow$}&$\downarrow$&&&&&$\downarrow$& \\
		\hline
	\end{tabular}
 \begin{tablenotes}
	\item[1] $\uparrow\uparrow$, $\uparrow$, $\downarrow\downarrow$, $\downarrow$: increase, decrease.
	\item[2] $(\uparrow)$, $(\downarrow)$: might increase/decrease.

\end{tablenotes}
\end{threeparttable}
\end{table}

%TODO: DATA STRUCTURE SECTION
